...
// const [checkArray, setCheckArray]  = useState([])
  ...
  //  const [wordData, setWordData] = useContext(WordContext)
  //  const [meaning, synonyms, example ] = wordData
 ...
 //save a dictionary searched word to personalised word list  
  ...
  return (
    <>
      ...
      <div className="row">
        <div className="col-md-3"> </div>
        <div className="col-md-6" style={{padding:"3em", backgroundColor:'#fff060'}}> 
